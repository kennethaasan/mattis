...
Then, please create a plan and implement the following features in the project:
...
When done, please ensure that linting, testing, and prettier are all passing again.
